...
const AirdropperABI = "[{\"constant\":false,\"inputs\":[{\"name\":\"_token\",\"type\":\"address\"}],\"name\":\"setToken\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[{\"name\":\"recipients\",\"type\":\"address[]\"},{\"name\":\"amounts\",\"type\":\"uint256[]\"}],\"name\":\"airdrop\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[],\"name\":\"renounceOwnership\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[],\"name\":\"destroy\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[],\"name\":\"owner\",\"outputs\":[{\"name\":\"\",\"type\":\"address\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[{\"name\":\"newOwner\",\"type\":\"address\"}],\"name\":\"transferOwnership\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[],\"name\":\"token\",\"outputs\":[{\"name\":\"\",\"type\":\"address\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[{\"name\":\"_token\",\"type\":\"address\"}],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"constructor\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":true,\"name\":\"previousOwner\",\"type\":\"address\"}],\"name\":\"OwnershipRenounced\",\"type\":\"event\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":true,\"name\":\"previousOwner\",\"type\":\"address\"},{\"indexed\":true,\"name\":\"newOwner\",\"type\":\"address\"}],\"name\":\"OwnershipTransferred\",\"type\":\"event\"}]"

// AirdropperBin is the compiled bytecode used for deploying new contracts.
const AirdropperBin = ``

// DeployAirdropper deploys a new Ethereum contract, binding an instance of Airdropper to it.
func DeployAirdropper(auth *bind.TransactOpts, backend bind.ContractBackend, _token common.Address) (common.Address, *types.Transaction, *Airdropper, error) {
	parsed, err := abi.JSON(strings.NewReader(AirdropperABI))
	if err != nil {
		return common.Address{}, nil, nil, err
	}
	address, tx, contract, err := bind.DeployContract(auth, parsed, common.FromHex(AirdropperBin), backend, _token)
	if err != nil {
		return common.Address{}, nil, nil, err
	}
...
func (_Airdropper *AirdropperCaller) Token(opts *bind.CallOpts) (common.Address, error) {
	var (
		ret0 = new(common.Address)
	)
	out := ret0
	err := _Airdropper.contract.Call(opts, out, "token")
	return *ret0, err
}
...
//
// Solidity: function token() constant returns(address)
func (_Airdropper *AirdropperSession) Token() (common.Address, error) {
	return _Airdropper.Contract.Token(&_Airdropper.CallOpts)
}

// Token is a free data retrieval call binding the contract method 0xfc0c546a.
//
// Solidity: function token() constant returns(address)
func (_Airdropper *AirdropperCallerSession) Token() (common.Address, error) {
	return _Airdropper.Contract.Token(&_Airdropper.CallOpts)
}

// Airdrop is a paid mutator transaction binding the contract method 0x67243482.
//
// Solidity: function airdrop(recipients address[], amounts uint256[]) returns()
func (_Airdropper *AirdropperTransactor) Airdrop(opts *bind.TransactOpts, recipients []common.Address, amounts []*big.Int) (*types.Transaction, error) {
	return _Airdropper.contract.Transact(opts, "airdrop", recipients, amounts)
}

// Airdrop is a paid mutator transaction binding the contract method 0x67243482.
//
// Solidity: function airdrop(recipients address[], amounts uint256[]) returns()
func (_Airdropper *AirdropperSession) Airdrop(recipients []common.Address, amounts []*big.Int) (*types.Transaction, error) {
	return _Airdropper.Contract.Airdrop(&_Airdropper.TransactOpts, recipients, amounts)
}

// Airdrop is a paid mutator transaction binding the contract method 0x67243482.
//
// Solidity: function airdrop(recipients address[], amounts uint256[]) returns()
func (_Airdropper *AirdropperTransactorSession) Airdrop(recipients []common.Address, amounts []*big.Int) (*types.Transaction, error) {
	return _Airdropper.Contract.Airdrop(&_Airdropper.TransactOpts, recipients, amounts)
}
...
func (_Airdropper *AirdropperTransactor) Destroy(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _Airdropper.contract.Transact(opts, "destroy")
}

// Destroy is a paid mutator transaction binding the contract method 0x83197ef0.
//
// Solidity: function destroy() returns()
func (_Airdropper *AirdropperSession) Destroy() (*types.Transaction, error) {
	return _Airdropper.Contract.Destroy(&_Airdropper.TransactOpts)
}

// Destroy is a paid mutator transaction binding the contract method 0x83197ef0.
//
// Solidity: function destroy() returns()
func (_Airdropper *AirdropperTransactorSession) Destroy() (*types.Transaction, error) {
	return _Airdropper.Contract.Destroy(&_Airdropper.TransactOpts)
}
...
func (_Airdropper *AirdropperTransactor) SetToken(opts *bind.TransactOpts, _token common.Address) (*types.Transaction, error) {
	return _Airdropper.contract.Transact(opts, "setToken", _token)
}

// SetToken is a paid mutator transaction binding the contract method 0x144fa6d7.
//
// Solidity: function setToken(_token address) returns()
func (_Airdropper *AirdropperSession) SetToken(_token common.Address) (*types.Transaction, error) {
	return _Airdropper.Contract.SetToken(&_Airdropper.TransactOpts, _token)
}

// SetToken is a paid mutator transaction binding the contract method 0x144fa6d7.
//
// Solidity: function setToken(_token address) returns()
func (_Airdropper *AirdropperTransactorSession) SetToken(_token common.Address) (*types.Transaction, error) {
	return _Airdropper.Contract.SetToken(&_Airdropper.TransactOpts, _token)
}
...
// AirdropperOwnershipRenouncedIterator is returned from FilterOwnershipRenounced and is used to iterate over the raw logs and unpacked data for OwnershipRenounced events raised by the Airdropper contract.
type AirdropperOwnershipRenouncedIterator struct {
	Event *AirdropperOwnershipRenounced // Event containing the contract specifics and raw log
...
func (it *AirdropperOwnershipRenouncedIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(AirdropperOwnershipRenounced)
...
func (it *AirdropperOwnershipRenouncedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *AirdropperOwnershipRenouncedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// AirdropperOwnershipRenounced represents a OwnershipRenounced event raised by the Airdropper contract.
type AirdropperOwnershipRenounced struct {
...
func (_Airdropper *AirdropperFilterer) FilterOwnershipRenounced(opts *bind.FilterOpts, previousOwner []common.Address) (*AirdropperOwnershipRenouncedIterator, error) {
	...
	logs, sub, err := _Airdropper.contract.FilterLogs(opts, "OwnershipRenounced", previousOwnerRule)
	if err != nil {
		return nil, err
	}
	return &AirdropperOwnershipRenouncedIterator{contract: _Airdropper.contract, event: "OwnershipRenounced", logs: logs, sub: sub}, nil
}

// WatchOwnershipRenounced is a free log subscription operation binding the contract event 0xf8df31144d9c2f0f6b59d69b8b98abd5459d07f2742c4df920b25aae33c64820.
//
// Solidity: e OwnershipRenounced(previousOwner indexed address)
func (_Airdropper *AirdropperFilterer) WatchOwnershipRenounced(opts *bind.WatchOpts, sink chan<- *AirdropperOwnershipRenounced, previousOwner []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Airdropper.contract.WatchLogs(opts, "OwnershipRenounced", previousOwnerRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(AirdropperOwnershipRenounced)
				if err := _Airdropper.contract.UnpackLog(event, "OwnershipRenounced", log); err != nil {
					return err
				}
				event.Raw = log
